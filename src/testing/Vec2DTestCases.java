...
{
	//Used when comparing doubles, since floating-point math isn't always perfectly precise
	private static final double DOUBLE_CALC_PRECISION = 0.0000001;
	
	//Reference for double test cases: https://javadoc.io/doc/junit/junit/latest/index.html
	@Test
	public void UnitVectorTest()
	{
		...
		assertEquals(Math.PI / 2, vec1.angleBetween(vec2), DOUBLE_CALC_PRECISION);
		
		//Angle between positive and negative unit vectors should be 180 degrees
